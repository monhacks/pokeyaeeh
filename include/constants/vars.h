...
#define VAR_ROUTE118_STATE                               0x4071 // Unused Var
...
#define VAR_KECLEON_DEFEATED                             0x408B
...
#define VAR_PARTY_MENU_TUTOR_STATE                       0x40DB // Used to distinguis between the normal move relearner and egg move tutor(More could be added in the future).
...
#define VAR_SKY_BATTLE                                   0x40E5 // Sky Battle var
