...
#define FLAG_HIDDEN_ITEM_ROUTE_113_TM_IRON_DEFENSE           (FLAG_HIDDEN_ITEMS_START + 0x1E)
...
#define FLAG_ITEM_ABANDONED_SHIP_HIDDEN_FLOOR_ROOM_1_TM_BUBBLE_BEAM 0x44E
