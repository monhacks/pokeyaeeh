...
#define FLAG_UNUSED_0xFE                     0xFE // Unused Flag
...
#define FLAG_ITEM_AQUA_HIDEOUT_B1F_BIG_NUGGET                       0x46C
...
#define FLAG_SYS_ENABLE_MOVE_RELEARNERS             (SYSTEM_FLAGS + 0x85) // Enables move relearner options in the party menu
