...
#define FLAG_NO_BAG_USE              0x23 // Disables bag use in battle
...
#define FLAG_DEFEATED_LANCE                    0x4F
...
#define FLAG_RECEIVED_TM_ACROBATICS          0x6E
...
#define FLAG_RECEIVED_POKEVIAL_OLDALE        0x84
#define FLAG_RECEIVED_AMULET_COIN            0x85
#define FLAG_PENDING_DAYCARE_EGG             0x86
#define FLAG_THANKED_FOR_PLAYING_WITH_WALLY  0x87
#define FLAG_ENABLE_FIRST_WALLY_POKENAV_CALL 0x88 // Set after defeating Wally outside Mauville Gym. Will activate a call later to register Wally.
#define FLAG_RECEIVED_HM_CUT                 0x89
#define FLAG_SCOTT_CALL_FORTREE_GYM          0x8A // Triggers call from Scott after defeating Krypto
...
#define FLAG_HIDE_VOLCARONA                  0xCD
...
#define FLAG_RECEIVED_BATTLE_BOND_GRENINJA   0xDC
...
#define FLAG_ACCEPTED_KECLEON_QUEST          0x122
...
#define FLAG_UNUSED_0x127                    0x127 // Unused Flag
...
#define FLAG_MOVE_CAVE_OF_ORIGIN_EXPERT      0x133
...
#define FLAG_NEGATE_FOG_ACCURACY             0x1E3 // Negates Fog's accuracy drop
...
#define FLAG_HIDDEN_ITEM_LAVARIDGE_TOWN_FULL_HEAL            (FLAG_HIDDEN_ITEMS_START + 0x00)
#define FLAG_HIDDEN_ITEM_TRICK_HOUSE_NUGGET                  (FLAG_HIDDEN_ITEMS_START + 0x01)
#define FLAG_HIDDEN_ITEM_ROUTE_111_GRASS_CRYSTAL             (FLAG_HIDDEN_ITEMS_START + 0x02)
#define FLAG_HIDDEN_ITEM_ROUTE_113_PP_MAX                    (FLAG_HIDDEN_ITEMS_START + 0x03)
#define FLAG_HIDDEN_ITEM_ROUTE_114_FIRE_CRYSTAL              (FLAG_HIDDEN_ITEMS_START + 0x04)
#define FLAG_HIDDEN_ITEM_ROUTE_119_ELECTRIC_CRYSTAL          (FLAG_HIDDEN_ITEMS_START + 0x05)
#define FLAG_HIDDEN_ITEM_ROUTE_119_ULTRA_BALL                (FLAG_HIDDEN_ITEMS_START + 0x06)
#define FLAG_HIDDEN_ITEM_ROUTE_123_HEART_SCALE               (FLAG_HIDDEN_ITEMS_START + 0x07)
#define FLAG_HIDDEN_ITEM_UNDERWATER_124_WATER_CRYSTAL        (FLAG_HIDDEN_ITEMS_START + 0x08)
#define FLAG_HIDDEN_ITEM_UNDERWATER_124_HEART_SCALE          (FLAG_HIDDEN_ITEMS_START + 0x09)
...
#define FLAG_HIDDEN_ITEM_UNDERWATER_126_DEEP_SEA_TOOTH       (FLAG_HIDDEN_ITEMS_START + 0x0E)
#define FLAG_HIDDEN_ITEM_UNDERWATER_126_DEEP_SEA_SCALE       (FLAG_HIDDEN_ITEMS_START + 0x0F)
...
#define FLAG_HIDDEN_ITEM_ROUTE_113_GIMMIGHOUL_COIN           (FLAG_HIDDEN_ITEMS_START + 0x1E)
...
#define FLAG_HIDDEN_ITEM_ROUTE_104_ICE_CRYSTAL               (FLAG_HIDDEN_ITEMS_START + 0x25)
#define FLAG_HIDDEN_ITEM_UNDERWATER_124_HEART_SCALE_2        (FLAG_HIDDEN_ITEMS_START + 0x26)
#define FLAG_HIDDEN_ITEM_ROUTE_121_FIGHTING_CRYSTAL          (FLAG_HIDDEN_ITEMS_START + 0x27)
#define FLAG_HIDDEN_ITEM_ROUTE_121_NUGGET                    (FLAG_HIDDEN_ITEMS_START + 0x28)
#define FLAG_HIDDEN_ITEM_ROUTE_123_POISON_CRYSTAL            (FLAG_HIDDEN_ITEMS_START + 0x29)
#define FLAG_HIDDEN_ITEM_ROUTE_114_REVIVE                    (FLAG_HIDDEN_ITEMS_START + 0x2A)
#define FLAG_HIDDEN_ITEM_LILYCOVE_CITY_GROUND_CRYSTAL        (FLAG_HIDDEN_ITEMS_START + 0x2B)
#define FLAG_HIDDEN_ITEM_ROUTE_104_FLYING_CRYSTAL            (FLAG_HIDDEN_ITEMS_START + 0x2C)
#define FLAG_HIDDEN_ITEM_ROUTE_116_SUPER_POTION              (FLAG_HIDDEN_ITEMS_START + 0x2D)
#define FLAG_HIDDEN_ITEM_ROUTE_106_PSYCHIC_CRYSTAL           (FLAG_HIDDEN_ITEMS_START + 0x2E)
#define FLAG_HIDDEN_ITEM_ROUTE_106_HEART_SCALE               (FLAG_HIDDEN_ITEMS_START + 0x2F)
#define FLAG_HIDDEN_ITEM_GRANITE_CAVE_B2F_EVIOLITE           (FLAG_HIDDEN_ITEMS_START + 0x30)
#define FLAG_HIDDEN_ITEM_GRANITE_CAVE_B2F_MOON_STONE         (FLAG_HIDDEN_ITEMS_START + 0x31)
...
#define FLAG_HIDDEN_ITEM_ROUTE_111_FIGHTING_GEM              (FLAG_HIDDEN_ITEMS_START + 0x39)
#define FLAG_HIDDEN_ITEM_PETALBURG_WOODS_BUG_GEM             (FLAG_HIDDEN_ITEMS_START + 0x3A)
#define FLAG_HIDDEN_ITEM_PETALBURG_WOODS_TINY_MUSHROOM       (FLAG_HIDDEN_ITEMS_START + 0x3B)
#define FLAG_HIDDEN_ITEM_PETALBURG_WOODS_LEAF_STONE          (FLAG_HIDDEN_ITEMS_START + 0x3C)
#define FLAG_HIDDEN_ITEM_PETALBURG_WOODS_BUG_CRYSTAL         (FLAG_HIDDEN_ITEMS_START + 0x3D)
#define FLAG_HIDDEN_ITEM_ROUTE_104_ROCK_CRYSTAL              (FLAG_HIDDEN_ITEMS_START + 0x3E)
...
#define FLAG_HIDDEN_ITEM_ROUTE_110_STEEL_CRYSTAL             (FLAG_HIDDEN_ITEMS_START + 0x41)
#define FLAG_HIDDEN_ITEM_ROUTE_118_HEART_SCALE               (FLAG_HIDDEN_ITEMS_START + 0x42)
#define FLAG_HIDDEN_ITEM_ROUTE_118_LEFTOVERS                 (FLAG_HIDDEN_ITEMS_START + 0x43)
#define FLAG_HIDDEN_ITEM_ROUTE_119_FULL_HEAL                 (FLAG_HIDDEN_ITEMS_START + 0x44)
#define FLAG_HIDDEN_ITEM_ROUTE_120_WATER_GEM                 (FLAG_HIDDEN_ITEMS_START + 0x45)
#define FLAG_HIDDEN_ITEM_ROUTE_120_ZINC                      (FLAG_HIDDEN_ITEMS_START + 0x46)
#define FLAG_HIDDEN_ITEM_ROUTE_120_LEAF_STONE                (FLAG_HIDDEN_ITEMS_START + 0x47)
#define FLAG_HIDDEN_ITEM_ROUTE_117_GRASS_GEM                 (FLAG_HIDDEN_ITEMS_START + 0x48)
...
#define FLAG_HIDDEN_ITEM_MT_PYRE_SUMMIT_GHOST_CRYSTAL        (FLAG_HIDDEN_ITEMS_START + 0x4F)
#define FLAG_HIDDEN_ITEM_MT_PYRE_SUMMIT_GHOST_GEM            (FLAG_HIDDEN_ITEMS_START + 0x50)
...
#define FLAG_HIDDEN_ITEM_VICTORY_ROAD_B2F_GROUND_GEM         (FLAG_HIDDEN_ITEMS_START + 0x53)
...
#define FLAG_HIDDEN_ITEM_ROUTE_108_ICE_GEM                   (FLAG_HIDDEN_ITEMS_START + 0x56)
...
#define FLAG_HIDDEN_ITEM_PETALBURG_CITY_BUG_CRYSTAL          (FLAG_HIDDEN_ITEMS_START + 0x5F)
#define FLAG_HIDDEN_ITEM_ROUTE_116_BLACK_GLASSES             (FLAG_HIDDEN_ITEMS_START + 0x60)
#define FLAG_HIDDEN_ITEM_ROUTE_115_DRAGON_CRYSTAL            (FLAG_HIDDEN_ITEMS_START + 0x61)
#define FLAG_HIDDEN_ITEM_ROUTE_113_DARK_CRYSTAL              (FLAG_HIDDEN_ITEMS_START + 0x62)
#define FLAG_UNUSED_0x63                                     (FLAG_HIDDEN_ITEMS_START + 0x63)
...
#define FLAG_HIDDEN_ITEM_SAFARI_ZONE_SOUTH_EAST_LUM_BERRY    (FLAG_HIDDEN_ITEMS_START + 0x69)
#define FLAG_HIDDEN_ITEM_SAFARI_ZONE_NORTH_EAST_FAIRY_GEM    (FLAG_HIDDEN_ITEMS_START + 0x6A)
#define FLAG_HIDDEN_ITEM_SAFARI_ZONE_NORTH_EAST_ZINC         (FLAG_HIDDEN_ITEMS_START + 0x6B)
#define FLAG_HIDDEN_ITEM_SAFARI_ZONE_SOUTH_EAST_PP_MAX       (FLAG_HIDDEN_ITEMS_START + 0x6C)
#define FLAG_HIDDEN_ITEM_NAVEL_ROCK_TOP_SACRED_ASH           (FLAG_HIDDEN_ITEMS_START + 0x6D)
#define FLAG_HIDDEN_ITEM_ROUTE_123_FIRE_GEM                  (FLAG_HIDDEN_ITEMS_START + 0x6E)
...
#define FLAG_HIDDEN_ITEM_UNUSED_0x26A                        (FLAG_HIDDEN_ITEMS_START + 0x76)
#define FLAG_HIDDEN_ITEM_UNUSED_0x26B                        (FLAG_HIDDEN_ITEMS_START + 0x77)
#define FLAG_HIDDEN_ITEM_UNUSED_0x26C                        (FLAG_HIDDEN_ITEMS_START + 0x78)
#define FLAG_HIDDEN_ITEM_UNUSED_0x26D                        (FLAG_HIDDEN_ITEMS_START + 0x79)
#define FLAG_HIDDEN_ITEM_UNUSED_0x26E                        (FLAG_HIDDEN_ITEMS_START + 0x7A)
#define FLAG_HIDDEN_ITEM_UNUSED_0x26F                        (FLAG_HIDDEN_ITEMS_START + 0x7B)
#define FLAG_HIDDEN_ITEM_UNUSED_0x270                        (FLAG_HIDDEN_ITEMS_START + 0x7C)
...
// New Item Ball Flags
#define FLAG_ITEM_MAGMA_HIDEOUT_4F_CAMERUPTITE                      0x274
...
#define FLAG_HIDE_FORTREE_CITY_KECLEON_3                            0x3D5
...
#define FLAG_ITEM_ROUTE_119_GIMMIGHOUL_COINS_2                      0x404
...
#define FLAG_ITEM_TRICK_HOUSE_PUZZLE_2_ICE_GEM                      0x425
#define FLAG_ITEM_TRICK_HOUSE_PUZZLE_2_WATER_GEM                    0x426
#define FLAG_ITEM_TRICK_HOUSE_PUZZLE_3_GHOST_GEM                    0x427
#define FLAG_ITEM_TRICK_HOUSE_PUZZLE_3_GRASS_GEM                    0x428
#define FLAG_ITEM_TRICK_HOUSE_PUZZLE_4_STEEL_GEM                    0x429
...
#define FLAG_RECEIVED_HM_FLY                                        0x46D
...
#define FLAG_ITEM_ROUTE_127_GIMMIGHOUL_COINS_3                      0x483
#define FLAG_ITEM_ROUTE_132_GIMMIGHOUL_COINS_2                      0x484
#define FLAG_ITEM_ROUTE_133_MAX_REVIVE                              0x485
#define FLAG_ITEM_ROUTE_134_GIMMIGHOUL_COINS                        0x486
#define FLAG_ITEM_ROUTE_134_STAR_PIECE                              0x487
#define FLAG_ITEM_ROUTE_114_ENERGY_POWDER                           0x488
#define FLAG_ITEM_ROUTE_115_GIMMIGHOUL_COINS_2                      0x489
#define FLAG_ITEM_ARTISAN_CAVE_B1F_GIMMIGHOUL_COINS                 0x48A
#define FLAG_ITEM_ARTISAN_CAVE_1F_GIMMIGHOUL_COINS                  0x48B
#define FLAG_ITEM_MAGMA_HIDEOUT_2F_2R_MAX_ELIXIR                    0x48C
#define FLAG_ITEM_MAGMA_HIDEOUT_2F_2R_FULL_RESTORE                  0x48D
#define FLAG_ITEM_MAGMA_HIDEOUT_3F_1R_BIG_NUGGET                    0x48E
#define FLAG_ITEM_MAGMA_HIDEOUT_3F_2R_GIMMIGHOUL_COINS              0x48F
...
#define FLAG_ROUTE_105_BOSS_DEFEATED                                0x496 // Route 105 Boss Maniac Foster
...
#define FLAG_RECEIVED_LUCARIONITE                                   0x4FF
...
#define FLAG_DAILY_FLOWER_SHOP_RECEIVED_MINT        (DAILY_FLAGS_START + 0x0)
