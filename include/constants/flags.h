...
#define FLAG_HIDDEN_ITEM_GRANITE_CAVE_B2F_EVERSTONE          (FLAG_HIDDEN_ITEMS_START + 0x31)
...
#define FLAG_HIDDEN_ITEM_PETALBURG_WOODS_MAX_REPEL           (FLAG_HIDDEN_ITEMS_START + 0x3A)
...
#define FLAG_ITEM_SEAFLOOR_CAVERN_ROOM_7_DREDNITE 0x283
