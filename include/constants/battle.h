...
#define B_WEATHER_MOON_TEMPORARY      (1 << 17)
#define B_WEATHER_MOON_PERMANENT      (1 << 18)
#define B_WEATHER_MOON                (B_WEATHER_MOON_TEMPORARY | B_WEATHER_MOON_PERMANENT)

#define B_WEATHER_ANY                 (B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_SUN | B_WEATHER_HAIL | B_WEATHER_SNOW | B_WEATHER_FOG | B_WEATHER_MOON | B_WEATHER_STRONG_WINDS | B_WEATHER_GHOSTLY_WINDS)
...
#define VICTORY_CATCH_OPEN_BAG 2
#define VICTORY_CATCH_FAINTED  3
