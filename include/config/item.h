...
#define I_GEM_BOOST_POWER               GEN_5       // In Gen5+, the Gem boost power was reduced from 50% to 30%.
...
#define I_EXP_SHARE_FLAG        FLAG_GEN6EXP_SHARE   // If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not.
