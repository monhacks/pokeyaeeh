...
#define B_PROTEAN_LIBERO            GEN_8      // In Gen9+, Protean and Libero only activate once per switch in.
...
#define B_FLAG_FORCE_DOUBLE_WILD    FLAG_FORCE_DOUBLE_BATTLE   // If this flag is set, all land and surfing wild battles will be double battles.
