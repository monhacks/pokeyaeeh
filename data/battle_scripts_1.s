...
BattleScript_GearUpDoSpeed:
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_GearUpTrySpAtk
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_GearUpTrySpAtk
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_GearUpTrySpAtk:
	setstatchanger STAT_SPATK, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_GearUpEnd
...
BattleScript_HandleFaintedMon::
	...
	jumpifbattletype BATTLE_TYPE_TRAINER | BATTLE_TYPE_DOUBLE | BATTLE_TYPE_LEGENDARY, BattleScript_FaintedMonTryChoose
...
BattleScript_WildWishMegaEvolution::
	flushtextbox
	trytrainerslidemegaevolutionmsg
	printstring STRINGID_WILDWISHMEGAEVO
	goto BattleScript_MegaEvolutionAfterString
...
BattleScript_EscapeArtistActivates::
	jumpifcantswitch SWITCH_IGNORE_ESCAPE_PREVENTION | BS_ATTACKER, BattleScript_EscapeArtistEnd
	call BattleScript_AbilityPopUp
	waitmessage B_WAIT_TIME_SHORT
	setbyte sB_ANIM_TURN, 0
	setbyte sB_ANIM_TARGETS_HIT, 0
	orword gHitMarker, HITMARKER_ALLOW_NO_PP
	attackcanceler
	printstring STRINGID_ESCASPEARTISTTELEPORTED
	jumpifcantswitch SWITCH_IGNORE_ESCAPE_PREVENTION | BS_ATTACKER, BattleScript_ButItFailed
	playmoveanimation BS_ATTACKER, MOVE_TELEPORT
	waitanimation
	flushtextbox
	openpartyscreen BS_ATTACKER, BattleScript_ButItFailed
	switchoutabilities BS_ATTACKER
...
BattleScript_EffectFrostGlare::
	attackcanceler
	attackstring
	ppreduce
	jumpifsubstituteblocks BattleScript_ButItFailed
	jumpifstatus BS_TARGET, STATUS1_FROSTBITE, BattleScript_AlreadyHasFrostbite
...
BattleScript_AlreadyHasFrostbite::
	setalreadystatusedmoveattempt BS_ATTACKER
	pause B_WAIT_TIME_SHORT
