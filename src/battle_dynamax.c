...
{
    {SPECIES_BUTTERFREE_MEGA,                 TYPE_BUG,        MOVE_G_MAX_BEFUDDLE},
    {SPECIES_MACHAMP_MEGA,                    TYPE_FIGHTING,   MOVE_G_MAX_CHI_STRIKE},
    {SPECIES_KINGLER_MEGA,                    TYPE_WATER,      MOVE_G_MAX_FOAM_BURST},
    {SPECIES_LAPRAS_MEGA,                     TYPE_ICE,        MOVE_G_MAX_RESONANCE},
    {SPECIES_GARBODOR_MEGA,                   TYPE_POISON,     MOVE_G_MAX_MALODOR},
    {SPECIES_MELMETAL_MEGA,                   TYPE_STEEL,      MOVE_G_MAX_MELTDOWN},
    {SPECIES_RILLABOOM_MEGA,                  TYPE_GRASS,      MOVE_G_MAX_DRUM_SOLO},
    {SPECIES_CINDERACE_MEGA,                  TYPE_FIRE,       MOVE_G_MAX_FIREBALL},
    {SPECIES_INTELEON_MEGA,                   TYPE_WATER,      MOVE_G_MAX_HYDROSNIPE},
    {SPECIES_CORVIKNIGHT_MEGA,                TYPE_FLYING,     MOVE_G_MAX_WIND_RAGE},
    {SPECIES_ORBEETLE_MEGA,                   TYPE_PSYCHIC,    MOVE_G_MAX_GRAVITAS},
    {SPECIES_DREDNAW_MEGA,                    TYPE_WATER,      MOVE_G_MAX_STONESURGE},
    {SPECIES_COALOSSAL_MEGA,                  TYPE_ROCK,       MOVE_G_MAX_VOLCALITH},
    {SPECIES_SANDACONDA_MEGA,                 TYPE_GROUND,     MOVE_G_MAX_SANDBLAST},
    {SPECIES_CENTISKORCH_MEGA,                TYPE_FIRE,       MOVE_G_MAX_CENTIFERNO},
    {SPECIES_HATTERENE_MEGA,                  TYPE_FAIRY,      MOVE_G_MAX_SMITE},
    {SPECIES_GRIMMSNARL_MEGA,                 TYPE_DARK,       MOVE_G_MAX_SNOOZE},
    {SPECIES_COPPERAJAH_MEGA,                 TYPE_STEEL,      MOVE_G_MAX_STEELSURGE},
    {SPECIES_URSHIFU_SINGLE_STRIKE_STYLE_MEGA,TYPE_DARK,       MOVE_G_MAX_ONE_BLOW},
    {SPECIES_URSHIFU_RAPID_STRIKE_STYLE_MEGA, TYPE_WATER,      MOVE_G_MAX_RAPID_FLOW},
};
