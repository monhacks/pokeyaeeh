...
EWRAM_DATA u8 gDisplayedStringBattle[425] = {0}; // Increased in size to fit Chal's defeat text (SootopolisCity_Gym_1F_Text_JuanDefeat)
...
const u8 gFullTypeNames[NUMBER_OF_MON_TYPES][TYPE_NAME_LENGTH + 4] =
{
    [TYPE_NORMAL] = _("Normal"),
...
{
    TRAINER_CLASS(PKMN_TRAINER_1, "{PKMN} Trainer", 50),
    TRAINER_CLASS(PKMN_TRAINER_2, "{PKMN} Trainer", 50),
    TRAINER_CLASS(HIKER, "Hiker", 20),
    TRAINER_CLASS(TEAM_AQUA, "Team Aqua", 50),
    TRAINER_CLASS(PKMN_BREEDER, "{PKMN} Breeder", 20, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? ITEM_HEAL_BALL : ITEM_FRIEND_BALL),
    TRAINER_CLASS(COOLTRAINER, "Cool trainer", 24, ITEM_ULTRA_BALL),
    TRAINER_CLASS(BIRD_KEEPER, "Bird Keeper", 20),
    TRAINER_CLASS(COLLECTOR, "Collector", 30, ITEM_PREMIER_BALL),
    TRAINER_CLASS(SWIMMER_M, "Swimmer♂", 20, ITEM_DIVE_BALL),
    TRAINER_CLASS(TEAM_MAGMA, "Team Magma", 50),
    TRAINER_CLASS(EXPERT, "Expert", 20),
    TRAINER_CLASS(AQUA_ADMIN, "Aqua Admin", 80),
    TRAINER_CLASS(BLACK_BELT, "Black Belt", 20, ITEM_ULTRA_BALL),
    TRAINER_CLASS(AQUA_LEADER, "Aqua Leader", 100, ITEM_MASTER_BALL),
    TRAINER_CLASS(HEX_MANIAC, "Hex Maniac", 20),
    TRAINER_CLASS(AROMA_LADY, "Aroma Lady", 20),
    TRAINER_CLASS(RUIN_MANIAC, "Ruin Maniac", 30),
    TRAINER_CLASS(INTERVIEWER, "Interviewer", 24),
    TRAINER_CLASS(TUBER_F, "Tuber", 20),
    TRAINER_CLASS(TUBER_M, "Tuber", 20),
    TRAINER_CLASS(LADY, "Lady", 100),
    TRAINER_CLASS(BEAUTY, "Beauty", 80),
    TRAINER_CLASS(RICH_BOY, "Rich Boy", 100),
    TRAINER_CLASS(POKEMANIAC, "Pokémaniac", 30),
    TRAINER_CLASS(GUITARIST, "Guitarist", 20),
    TRAINER_CLASS(KINDLER, "Kindler", 20),
    TRAINER_CLASS(CAMPER, "Camper", 10),
    TRAINER_CLASS(PICNICKER, "Picnicker", 20),
    TRAINER_CLASS(BUG_MANIAC, "Bug Maniac", 30),
    TRAINER_CLASS(PSYCHIC, "Psychic", 20),
    TRAINER_CLASS(GENTLEMAN, "Gentleman", 80, ITEM_LUXURY_BALL),
    TRAINER_CLASS(ELITE_FOUR, "Elite Four", 150, ITEM_ULTRA_BALL),
    TRAINER_CLASS(LEADER, "Leader", 150),
    TRAINER_CLASS(SCHOOL_KID, "School Kid", 20),
    TRAINER_CLASS(SR_AND_JR, "Sr. and Jr.", 20),
    TRAINER_CLASS(WINSTRATE, "Winstrate", 20),
    TRAINER_CLASS(POKEFAN, "Pokéfan", 40),
    TRAINER_CLASS(YOUNGSTER, "Youngster", 20),
    TRAINER_CLASS(CHAMPION, "Champion", 150),
    TRAINER_CLASS(FISHERMAN, "Fisherman", 20, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? ITEM_DIVE_BALL : ITEM_LURE_BALL),
    TRAINER_CLASS(TRIATHLETE, "Triathlete", 20),
    TRAINER_CLASS(DRAGON_TAMER, "Dragon Tamer", 24),
    TRAINER_CLASS(NINJA_BOY, "Ninja Boy", 20),
    TRAINER_CLASS(BATTLE_GIRL, "Battle Girl", 20),
    TRAINER_CLASS(PARASOL_LADY, "Parasol Lady", 20),
    TRAINER_CLASS(SWIMMER_F, "Swimmer♀", 20, ITEM_DIVE_BALL),
    TRAINER_CLASS(TWINS, "Twins", 20),
    TRAINER_CLASS(SAILOR, "Sailor", 20),
    TRAINER_CLASS(COOLTRAINER_2, "Cooltrainer", 20, ITEM_ULTRA_BALL),
    TRAINER_CLASS(MAGMA_ADMIN, "Magma Admin", 80),
    TRAINER_CLASS(RIVAL, "{PKMN} Trainer", 50),
    TRAINER_CLASS(BUG_CATCHER, "Buh Catcher", 20),
    TRAINER_CLASS(PKMN_RANGER, "{PKMN} Ranger", 24),
    TRAINER_CLASS(MAGMA_LEADER, "Magma Leader", 100, ITEM_MASTER_BALL),
    TRAINER_CLASS(LASS, "Lass", 20),
    TRAINER_CLASS(YOUNG_COUPLE, "Young Couple", 20),
    TRAINER_CLASS(OLD_COUPLE, "Old Couple", 20),
    TRAINER_CLASS(SIS_AND_BRO, "Sis and Bro", 20),
    ...
    TRAINER_CLASS(RS_PROTAG, "{PKMN} Trainer", 20),
    TRAINER_CLASS(ROUTE_BOSS, "Route Boss", 50),
};
...
u32 GetBattlerTotalSpeedStatArgs(u32 battler, u32 ability, u32 holdEffect)
{
    ...
    if (ability == ABILITY_QUICK_FEET && gBattleMons[battler].status1 & STATUS1_ANY)
        ...
        speed = (speed * 150) / 100;
    else if (ability == ABILITY_RUN_AWAY && ((gBattleMons[battler].hp) <= (gBattleMons[battler].maxHP / 2)))
        speed *= 2;
...
static void TurnValuesCleanUp(bool8 var0)
{
    ...
    for (i = 0; i < gBattlersCount; i++)
    {
        ...
        gSpecialStatuses[i].boxerBarrageState = BOXER_OFF;
    }
