...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    TRAINER_CLASS(COOLTRAINER, "Cool trainer", 12, ITEM_ULTRA_BALL),
    ...
    TRAINER_CLASS(AQUA_LEADER, "Aqua Leader", 35, ITEM_MASTER_BALL),
    ...
    TRAINER_CLASS(GENTLEMAN, "Gentleman", 30, ITEM_LUXURY_BALL),
    TRAINER_CLASS(ELITE_FOUR, "Elite Four", 50, ITEM_ULTRA_BALL),
    TRAINER_CLASS(LEADER, "Leader", 50),
    ...
    TRAINER_CLASS(BUG_CATCHER, "Buh Catcher", 4),
    TRAINER_CLASS(PKMN_RANGER, "{PKMN} Ranger", 12),
    TRAINER_CLASS(MAGMA_LEADER, "Magma Leader", 35, ITEM_MASTER_BALL),
