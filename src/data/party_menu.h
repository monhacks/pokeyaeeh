...
static const u16 sFieldMoves[] =
{
    ...
    MOVE_DIG, MOVE_SECRET_POWER, MOVE_MILK_DRINK, MOVE_SOFT_BOILED, MOVE_ROCK_CLIMB, MOVE_SWEET_SCENT, FIELD_MOVE_TERMINATOR
};
...
static const u16 sTutorMovesMoves[300] =
{
    MOVE_ACID_SPRAY,
    MOVE_AFTER_YOU,
    MOVE_AGILITY,
