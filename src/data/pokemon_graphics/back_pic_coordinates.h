...
const struct MonCoords gMonBackPicCoords[NUM_SPECIES + 1] =
{
    ...
    [SPECIES_ROWLET]                       = { .size = MON_COORDS_SIZE(43, 36), .y_offset = 15 },
    [SPECIES_DARTRIX]                      = { .size = MON_COORDS_SIZE(56, 54), .y_offset =  4 },
    [SPECIES_DECIDUEYE]                    = { .size = MON_COORDS_SIZE(46, 62), .y_offset =  0 },
    ...
    [SPECIES_PASSIMIAN]                    = { .size = MON_COORDS_SIZE(51, 52), .y_offset =  7 },
    ...
    [SPECIES_JANGMO_O]                     = { .size = MON_COORDS_SIZE(42, 56), .y_offset =  5 },
    [SPECIES_HAKAMO_O]                     = { .size = MON_COORDS_SIZE(49, 56), .y_offset =  5 },
    [SPECIES_KOMMO_O]                      = { .size = MON_COORDS_SIZE(60, 60), .y_offset =  2 },
    ...
    [SPECIES_BASCULEGION_MALE]             = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  8 },
    ...
    [SPECIES_FLUTTER_MANE]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
 ...
 // Hisuian Forms
    ...
    // Gigantamax Megas
    [SPECIES_BUTTERFREE_MEGA] = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 3 },
    [SPECIES_MACHAMP_MEGA] = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 3 },
    [SPECIES_KINGLER_MEGA] = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 5 },
    [SPECIES_LAPRAS_MEGA] = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 1 },
    [SPECIES_GARBODOR_MEGA] = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 2 },
    [SPECIES_MELMETAL_MEGA] = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 14 },
    [SPECIES_RILLABOOM_MEGA] = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 4 },
    [SPECIES_CINDERACE_MEGA] = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 4 },
    [SPECIES_INTELEON_MEGA] = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 4 },
    [SPECIES_CORVIKNIGHT_MEGA] = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 3 },
    [SPECIES_ORBEETLE_MEGA] = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 6 },
    [SPECIES_DREDNAW_MEGA] = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12 },
    [SPECIES_COALOSSAL_MEGA] = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 8 },
    [SPECIES_SANDACONDA_MEGA] = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 5 },
    [SPECIES_CENTISKORCH_MEGA] = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 1 },
    [SPECIES_HATTERENE_MEGA] = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 3 },
    [SPECIES_GRIMMSNARL_MEGA] = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 10 },
    [SPECIES_COPPERAJAH_MEGA] = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 7 },
    [SPECIES_URSHIFU_SINGLE_STRIKE_STYLE_MEGA] = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 4 },
