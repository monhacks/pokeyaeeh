const struct CompressedSpriteSheet gMonBackPicTable[NUM_SPECIES + 1] =
{
    ...
    SPECIES_SPRITE(SILVALLY_NORMAL, gMonBackPic_Silvally),
    ...
    SPECIES_SPRITE(ALCREMIE_STRAWBERRY_VANILLA_CREAM, gMonBackPic_Alcremie),
    ...
    SPECIES_SPRITE(ZYGARDE_10_AURA_BREAK, gMonBackPic_Zygarde10),
    ...
    SPECIES_SPRITE(ETERNATUS_PRIMAL, gMonBackPic_EternatusEternamax),
    ...
    // Gigantamax Megas
    SPECIES_SPRITE(BUTTERFREE_MEGA, gMonBackPic_ButterfreeGigantamax),
    SPECIES_SPRITE(MACHAMP_MEGA, gMonBackPic_MachampGigantamax),
    SPECIES_SPRITE(KINGLER_MEGA, gMonBackPic_KinglerGigantamax),
    SPECIES_SPRITE(LAPRAS_MEGA, gMonBackPic_LaprasGigantamax),
    SPECIES_SPRITE(GARBODOR_MEGA, gMonBackPic_GarbodorGigantamax),
    SPECIES_SPRITE(MELMETAL_MEGA, gMonBackPic_MelmetalGigantamax),
    SPECIES_SPRITE(RILLABOOM_MEGA, gMonBackPic_RillaboomGigantamax),
    SPECIES_SPRITE(CINDERACE_MEGA, gMonBackPic_CinderaceGigantamax),
    SPECIES_SPRITE(INTELEON_MEGA, gMonBackPic_InteleonGigantamax),
    SPECIES_SPRITE(CORVIKNIGHT_MEGA, gMonBackPic_CorviknightGigantamax),
    SPECIES_SPRITE(ORBEETLE_MEGA, gMonBackPic_OrbeetleGigantamax),
    SPECIES_SPRITE(DREDNAW_MEGA, gMonBackPic_DrednawGigantamax),
    SPECIES_SPRITE(COALOSSAL_MEGA, gMonBackPic_CoalossalGigantamax),
    SPECIES_SPRITE(SANDACONDA_MEGA, gMonBackPic_SandacondaGigantamax),
    SPECIES_SPRITE(CENTISKORCH_MEGA, gMonBackPic_CentiskorchGigantamax),
    SPECIES_SPRITE(HATTERENE_MEGA, gMonBackPic_HattereneGigantamax),
    SPECIES_SPRITE(GRIMMSNARL_MEGA, gMonBackPic_GrimmsnarlGigantamax),
    SPECIES_SPRITE(COPPERAJAH_MEGA, gMonBackPic_CopperajahGigantamax),
    SPECIES_SPRITE(URSHIFU_SINGLE_STRIKE_STYLE_MEGA, gMonBackPic_UrshifuSingleStrikeGigantamax),
    SPECIES_SPRITE(URSHIFU_RAPID_STRIKE_STYLE_MEGA, gMonBackPic_UrshifuRapidStrikeGigantamax),
#endif
    ...
    SPECIES_SPRITE(OINKOLOGNE_MALE, gMonBackPic_Oinkologne),
    ...
    SPECIES_SPRITE(MAUSHOLD_FAMILY_OF_FOUR, gMonBackPic_Maushold),
    ...
    SPECIES_SPRITE(SQUAWKABILLY_GREEN_PLUMAGE, gMonBackPic_Squawkabilly),
    ...
    SPECIES_SPRITE(PALAFIN_ZERO, gMonBackPic_Palafin),
    ...
    SPECIES_SPRITE(DUDUNSPARCE_TWO_SEGMENT, gMonBackPic_Dudunsparce),
    ...
    SPECIES_SPRITE(GIMMIGHOUL_CHEST, gMonBackPic_Gimmighoul),
    ...
    SPECIES_SPRITE(OGERPON_TEAL_MASK, gMonBackPic_OgerponTeal),
    SPECIES_SPRITE(OGERPON_WELLSPRING_MASK, gMonBackPic_OgerponWellspring),
    SPECIES_SPRITE(OGERPON_HEARTHFLAME_MASK, gMonBackPic_OgerponHearthflame),
    SPECIES_SPRITE(OGERPON_CORNERSTONE_MASK, gMonBackPic_OgerponCornerstone),
    // SPECIES_SPRITE(OGERPON_TEAL_MASK_TERA, gMonBackPic_OgerponTealTera),
    // SPECIES_SPRITE(OGERPON_WELLSPRING_MASK_TERA, gMonBackPic_OgerponWellspringTera),
    // SPECIES_SPRITE(OGERPON_HEARTHFLAME_MASK_TERA, gMonBackPic_OgerponHearthflameTera),
    // SPECIES_SPRITE(OGERPON_CORNERSTONE_MASK_TERA, gMonBackPic_OgerponCornerstoneTera),
...
#endif
    SPECIES_SPRITE(NIDOQUEEN_MEGA, gMonBackPic_NidoqueenMega),
    SPECIES_SPRITE(NIDOKING_MEGA, gMonBackPic_NidokingMega),
    SPECIES_SPRITE(MILOTIC_MEGA, gMonBackPic_MiloticMega),
    SPECIES_SPRITE(RAICHU_MEGA, gMonBackPic_RaichuMega),
    SPECIES_SPRITE(TROPIUS_MEGA, gMonBackPic_TropiusMega),
