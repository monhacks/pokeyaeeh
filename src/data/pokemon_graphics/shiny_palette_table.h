const struct CompressedSpritePalette gMonShinyPaletteTable[NUM_SPECIES + 1] =
{
    ...
    // Gigantamax Megas
    SPECIES_SHINY_PAL(BUTTERFREE_MEGA, gMonShinyPalette_ButterfreeGigantamax),
    SPECIES_SHINY_PAL(MACHAMP_MEGA, gMonShinyPalette_MachampGigantamax),
    SPECIES_SHINY_PAL(KINGLER_MEGA, gMonShinyPalette_KinglerGigantamax),
    SPECIES_SHINY_PAL(LAPRAS_MEGA, gMonShinyPalette_LaprasGigantamax),
    SPECIES_SHINY_PAL(GARBODOR_MEGA, gMonShinyPalette_GarbodorGigantamax),
    SPECIES_SHINY_PAL(MELMETAL_MEGA, gMonShinyPalette_MelmetalGigantamax),
    SPECIES_SHINY_PAL(RILLABOOM_MEGA, gMonShinyPalette_RillaboomGigantamax),
    SPECIES_SHINY_PAL(CINDERACE_MEGA, gMonShinyPalette_CinderaceGigantamax),
    SPECIES_SHINY_PAL(INTELEON_MEGA, gMonShinyPalette_InteleonGigantamax),
    SPECIES_SHINY_PAL(CORVIKNIGHT_MEGA, gMonShinyPalette_CorviknightGigantamax),
    SPECIES_SHINY_PAL(ORBEETLE_MEGA, gMonShinyPalette_OrbeetleGigantamax),
    SPECIES_SHINY_PAL(DREDNAW_MEGA, gMonShinyPalette_DrednawGigantamax),
    SPECIES_SHINY_PAL(COALOSSAL_MEGA, gMonShinyPalette_CoalossalGigantamax),
    SPECIES_SHINY_PAL(SANDACONDA_MEGA, gMonShinyPalette_SandacondaGigantamax),
    SPECIES_SHINY_PAL(CENTISKORCH_MEGA, gMonShinyPalette_CentiskorchGigantamax),
    SPECIES_SHINY_PAL(HATTERENE_MEGA, gMonShinyPalette_HattereneGigantamax),
    SPECIES_SHINY_PAL(GRIMMSNARL_MEGA, gMonShinyPalette_GrimmsnarlGigantamax),
    SPECIES_SHINY_PAL(COPPERAJAH_MEGA, gMonShinyPalette_CopperajahGigantamax),
    SPECIES_SHINY_PAL(URSHIFU_SINGLE_STRIKE_STYLE_MEGA, gMonShinyPalette_UrshifuSingleStrikeGigantamax),
    SPECIES_SHINY_PAL(URSHIFU_RAPID_STRIKE_STYLE_MEGA, gMonShinyPalette_UrshifuRapidStrikeGigantamax),
#endif
    ...
    SPECIES_SHINY_PAL(OINKOLOGNE_MALE, gMonShinyPalette_Oinkologne),
    ...
    SPECIES_SHINY_PAL(PALAFIN_ZERO, gMonShinyPalette_Palafin),
    ...
    SPECIES_SHINY_PAL(GIMMIGHOUL_CHEST, gMonShinyPalette_Gimmighoul),
    ...
    SPECIES_SHINY_PAL(OGERPON_TEAL_MASK, gMonShinyPalette_OgerponTeal),
    SPECIES_SHINY_PAL(OGERPON_WELLSPRING_MASK, gMonShinyPalette_OgerponWellspring),
    SPECIES_SHINY_PAL(OGERPON_HEARTHFLAME_MASK, gMonShinyPalette_OgerponHearthflame),
    SPECIES_SHINY_PAL(OGERPON_CORNERSTONE_MASK, gMonShinyPalette_OgerponCornerstone),
    // SPECIES_SHINY_PAL(OGERPON_TEAL_MASK_TERA, gMonShinyPalette_OgerponTealTera),
    ...
    // SPECIES_SHINY_PAL(TERAPAGOS_NORMAL, gMonShinyPalette_TerapagosNormal),
...
#endif
    SPECIES_SHINY_PAL(NIDOQUEEN_MEGA, gMonShinyPalette_NidoqueenMega),
    SPECIES_SHINY_PAL(NIDOKING_MEGA, gMonShinyPalette_NidokingMega),
    SPECIES_SHINY_PAL(MILOTIC_MEGA, gMonShinyPalette_MiloticMega),
    SPECIES_SHINY_PAL(RAICHU_MEGA, gMonShinyPalette_RaichuMega),
    SPECIES_SHINY_PAL(TROPIUS_MEGA, gMonShinyPalette_TropiusMega),
