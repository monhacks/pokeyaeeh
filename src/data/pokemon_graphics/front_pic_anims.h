...
static const union AnimCmd sAnim_NidoqueenMega_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_NidokingMega_1[] = 
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
...
static const union AnimCmd sAnim_RaichuMega_1[] = 
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_TropiusMega_1[] = 
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
...
{   // Gen 1
    ...
    [SPECIES_ETERNATUS_PRIMAL]               = sAnims_Eternatus,
