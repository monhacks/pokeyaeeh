const struct CompressedSpritePalette gMonPaletteTable[NUM_SPECIES + 1] =
{
    ...
    SPECIES_PAL(ETERNATUS_PRIMAL, gMonPalette_EternatusEternamax),
    ...
    // Gigantamax Megas
    SPECIES_PAL(BUTTERFREE_MEGA, gMonPalette_ButterfreeGigantamax),
    SPECIES_PAL(MACHAMP_MEGA, gMonPalette_MachampGigantamax),
    SPECIES_PAL(KINGLER_MEGA, gMonPalette_KinglerGigantamax),
    SPECIES_PAL(LAPRAS_MEGA, gMonPalette_LaprasGigantamax),
    SPECIES_PAL(GARBODOR_MEGA, gMonPalette_GarbodorGigantamax),
    SPECIES_PAL(MELMETAL_MEGA, gMonPalette_MelmetalGigantamax),
    SPECIES_PAL(RILLABOOM_MEGA, gMonPalette_RillaboomGigantamax),
    SPECIES_PAL(CINDERACE_MEGA, gMonPalette_CinderaceGigantamax),
    SPECIES_PAL(INTELEON_MEGA, gMonPalette_InteleonGigantamax),
    SPECIES_PAL(CORVIKNIGHT_MEGA, gMonPalette_CorviknightGigantamax),
    SPECIES_PAL(ORBEETLE_MEGA, gMonPalette_OrbeetleGigantamax),
    SPECIES_PAL(DREDNAW_MEGA, gMonPalette_DrednawGigantamax),
    SPECIES_PAL(COALOSSAL_MEGA, gMonPalette_CoalossalGigantamax),
    SPECIES_PAL(SANDACONDA_MEGA, gMonPalette_SandacondaGigantamax),
    SPECIES_PAL(CENTISKORCH_MEGA, gMonPalette_CentiskorchGigantamax),
    SPECIES_PAL(HATTERENE_MEGA, gMonPalette_HattereneGigantamax),
    SPECIES_PAL(GRIMMSNARL_MEGA, gMonPalette_GrimmsnarlGigantamax),
    SPECIES_PAL(COPPERAJAH_MEGA, gMonPalette_CopperajahGigantamax),
    SPECIES_PAL(URSHIFU_SINGLE_STRIKE_STYLE_MEGA, gMonPalette_UrshifuSingleStrikeGigantamax),
    SPECIES_PAL(URSHIFU_RAPID_STRIKE_STYLE_MEGA, gMonPalette_UrshifuRapidStrikeGigantamax),
#endif
    ...
    SPECIES_PAL(OINKOLOGNE_MALE, gMonPalette_Oinkologne),
    ...
    SPECIES_PAL(MAUSHOLD_FAMILY_OF_FOUR, gMonPalette_Maushold),
    ...
    SPECIES_PAL(PALAFIN_ZERO, gMonPalette_Palafin),
    ...
    SPECIES_PAL(GIMMIGHOUL_CHEST, gMonPalette_Gimmighoul),
    ...
    SPECIES_PAL(OGERPON_TEAL_MASK, gMonPalette_OgerponTeal),
    SPECIES_PAL(OGERPON_WELLSPRING_MASK, gMonPalette_OgerponWellspring),
    SPECIES_PAL(OGERPON_HEARTHFLAME_MASK, gMonPalette_OgerponHearthflame),
    SPECIES_PAL(OGERPON_CORNERSTONE_MASK, gMonPalette_OgerponCornerstone),
    // SPECIES_PAL(OGERPON_TEAL_MASK_TERA, gMonPalette_OgerponTealTera),
    ...
    SPECIES_PAL(RAICHU_MEGA, gMonPalette_RaichuMega),
    SPECIES_PAL(TROPIUS_MEGA, gMonPalette_TropiusMega),
