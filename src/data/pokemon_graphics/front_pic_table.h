const struct CompressedSpriteSheet gMonFrontPicTable[NUM_SPECIES + 1] =
{
    ...
    SPECIES_SPRITE(ARCEUS_NORMAL, gMonFrontPic_Arceus),
#endif
    ...
    SPECIES_SPRITE(BASCULIN_RED_STRIPED, gMonFrontPic_BasculinRedStriped),
    ...
    SPECIES_SPRITE(MELOETTA_ARIA, gMonFrontPic_MeloettaAria),
    ...
    SPECIES_SPRITE(SILVALLY_NORMAL, gMonFrontPic_Silvally),
    ...
    SPECIES_SPRITE(ALCREMIE_STRAWBERRY_VANILLA_CREAM, gMonFrontPic_Alcremie),
    ...
    SPECIES_SPRITE(ZYGARDE_10_AURA_BREAK, gMonFrontPic_Zygarde10),
    ...
    SPECIES_SPRITE(ETERNATUS_PRIMAL, gMonFrontPic_EternatusEternamax),
    ...
    // Gigantamax Megas
    SPECIES_SPRITE(BUTTERFREE_MEGA, gMonFrontPic_ButterfreeGigantamax),
    SPECIES_SPRITE(MACHAMP_MEGA, gMonFrontPic_MachampGigantamax),
    SPECIES_SPRITE(KINGLER_MEGA, gMonFrontPic_KinglerGigantamax),
    SPECIES_SPRITE(LAPRAS_MEGA, gMonFrontPic_LaprasGigantamax),
    SPECIES_SPRITE(GARBODOR_MEGA, gMonFrontPic_GarbodorGigantamax),
    SPECIES_SPRITE(MELMETAL_MEGA, gMonFrontPic_MelmetalGigantamax),
    SPECIES_SPRITE(RILLABOOM_MEGA, gMonFrontPic_RillaboomGigantamax),
    SPECIES_SPRITE(CINDERACE_MEGA, gMonFrontPic_CinderaceGigantamax),
    SPECIES_SPRITE(INTELEON_MEGA, gMonFrontPic_InteleonGigantamax),
    SPECIES_SPRITE(CORVIKNIGHT_MEGA, gMonFrontPic_CorviknightGigantamax),
    SPECIES_SPRITE(ORBEETLE_MEGA, gMonFrontPic_OrbeetleGigantamax),
    SPECIES_SPRITE(DREDNAW_MEGA, gMonFrontPic_DrednawGigantamax),
    SPECIES_SPRITE(COALOSSAL_MEGA, gMonFrontPic_CoalossalGigantamax),
    SPECIES_SPRITE(SANDACONDA_MEGA, gMonFrontPic_SandacondaGigantamax),
    SPECIES_SPRITE(CENTISKORCH_MEGA, gMonFrontPic_CentiskorchGigantamax),
    SPECIES_SPRITE(HATTERENE_MEGA, gMonFrontPic_HattereneGigantamax),
    SPECIES_SPRITE(GRIMMSNARL_MEGA, gMonFrontPic_GrimmsnarlGigantamax),
    SPECIES_SPRITE(COPPERAJAH_MEGA, gMonFrontPic_CopperajahGigantamax),
    SPECIES_SPRITE(URSHIFU_SINGLE_STRIKE_STYLE_MEGA, gMonFrontPic_UrshifuSingleStrikeGigantamax),
    SPECIES_SPRITE(URSHIFU_RAPID_STRIKE_STYLE_MEGA, gMonFrontPic_UrshifuRapidStrikeGigantamax),
#endif
    ...
    SPECIES_SPRITE(OINKOLOGNE_MALE, gMonFrontPic_Oinkologne),
    ...
    SPECIES_SPRITE(MAUSHOLD_FAMILY_OF_FOUR, gMonFrontPic_Maushold),
    ...
    SPECIES_SPRITE(PALAFIN_ZERO, gMonFrontPic_Palafin),
    ...
    SPECIES_SPRITE(DUDUNSPARCE_TWO_SEGMENT, gMonFrontPic_Dudunsparce),
    ...
    SPECIES_SPRITE(GIMMIGHOUL_CHEST, gMonFrontPic_Gimmighoul),
    ...
    SPECIES_SPRITE(OGERPON_TEAL_MASK, gMonFrontPic_OgerponTeal),
    SPECIES_SPRITE(OGERPON_WELLSPRING_MASK, gMonFrontPic_OgerponWellspring),
    SPECIES_SPRITE(OGERPON_HEARTHFLAME_MASK, gMonFrontPic_OgerponHearthflame),
    SPECIES_SPRITE(OGERPON_CORNERSTONE_MASK, gMonFrontPic_OgerponCornerstone),
    // SPECIES_SPRITE(OGERPON_TEAL_MASK_TERA, gMonFrontPic_OgerponTealTera),
...
#endif
    SPECIES_SPRITE(NIDOQUEEN_MEGA, gMonFrontPic_NidoqueenMega),
