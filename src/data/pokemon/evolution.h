const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PONYTA]                = {{EVO_LEVEL, 26, SPECIES_RAPIDASH}},
    ...
    [SPECIES_BOLDORE]               = {{EVO_ITEM, ITEM_LINKING_CORD, SPECIES_GIGALITH}},
    ...
    [SPECIES_GURDURR]               = {{EVO_ITEM, ITEM_LINKING_CORD, SPECIES_CONKELDURR}},
    ...
    [SPECIES_SCRAGGY]               = {{EVO_LEVEL, 36, SPECIES_SCRAFTY}},
    ...
    [SPECIES_GOTHITA]               = {{EVO_LEVEL, 24, SPECIES_GOTHORITA}},
    [SPECIES_GOTHORITA]             = {{EVO_LEVEL, 36, SPECIES_GOTHITELLE}},
    [SPECIES_SOLOSIS]               = {{EVO_LEVEL, 24, SPECIES_DUOSION}},
    [SPECIES_DUOSION]               = {{EVO_LEVEL, 36, SPECIES_REUNICLUS}},
    [SPECIES_DUCKLETT]              = {{EVO_LEVEL, 32, SPECIES_SWANNA}},
    [SPECIES_VANILLITE]             = {{EVO_LEVEL, 26, SPECIES_VANILLISH}},
    [SPECIES_VANILLISH]             = {{EVO_LEVEL, 40, SPECIES_VANILLUXE}},
    [SPECIES_DEERLING_SPRING]       = {{EVO_LEVEL, 34, SPECIES_SAWSBUCK_SPRING}},
    [SPECIES_KARRABLAST]            = {{EVO_ITEM, ITEM_STEEL_ARMOR, SPECIES_ESCAVALIER}},
    ...
    [SPECIES_KLINK]                 = {{EVO_LEVEL, 22, SPECIES_KLANG}},
    ...
    [SPECIES_MIENFOO]               = {{EVO_LEVEL, 38, SPECIES_MIENSHAO}},
    ...
    [SPECIES_RUFFLET]               = {{EVO_LEVEL, 36, SPECIES_BRAVIARY},
                                       {EVO_LEVEL_SPECIFIC_MAP, 36, SPECIES_BRAVIARY_HISUIAN, MAP_FIERY_PATH}}, // hisui
    ...
    [SPECIES_PHANTUMP]              = {{EVO_ITEM, ITEM_LINKING_CORD, SPECIES_TREVENANT}},
    [SPECIES_PUMPKABOO_AVERAGE]     = {{EVO_ITEM, ITEM_LINKING_CORD, SPECIES_GOURGEIST_AVERAGE}},
    ...
    [SPECIES_CHARJABUG]             = {{EVO_LEVEL, 42, SPECIES_VIKAVOLT}},
    ...
    [SPECIES_KUBFU]                 = {{EVO_ITEM, ITEM_SCROLL_OF_DARKNESS, SPECIES_URSHIFU_SINGLE_STRIKE_STYLE},
    ...
    [SPECIES_PAWMO]                 = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_PAWMOT}},
    ...
    [SPECIES_BRAMBLIN]              = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_BRAMBLEGHAST}},
    [SPECIES_TOEDSCOOL]             = {{EVO_LEVEL, 30, SPECIES_TOEDSCRUEL}},
    [SPECIES_CAPSAKID]              = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_SCOVILLAIN}},
    [SPECIES_RELLOR]                = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_RABSCA}},
    ...
    [SPECIES_FINIZEN]               = {{EVO_LEVEL, 38, SPECIES_PALAFIN_ZERO}},
    ...
    [SPECIES_GIMMIGHOUL_ROAMING]    = {{EVO_LEVEL_ITEM_COUNT_999, ITEM_GIMMIGHOUL_COIN, SPECIES_GHOLDENGO}},
    [SPECIES_POLTCHAGEIST_COUNTERFEIT] = {{EVO_ITEM, ITEM_UNREMARKABLE_TEACUP, SPECIES_SINISTCHA_UNREMARKABLE}},
    [SPECIES_DIPPLIN]               = {{EVO_MOVE, MOVE_DRAGON_CHEER, SPECIES_HYDRAPPLE}},
#endif
...
#endif
    [SPECIES_PONYTA_GALARIAN]       = {{EVO_LEVEL, 26, SPECIES_RAPIDASH_GALARIAN}},
    ...
    [SPECIES_PUMPKABOO_SMALL]       = {{EVO_ITEM, ITEM_LINKING_CORD, SPECIES_GOURGEIST_SMALL}},
    [SPECIES_PUMPKABOO_LARGE]       = {{EVO_ITEM, ITEM_LINKING_CORD, SPECIES_GOURGEIST_LARGE}},
    [SPECIES_PUMPKABOO_SUPER]       = {{EVO_ITEM, ITEM_LINKING_CORD, SPECIES_GOURGEIST_SUPER}},
#endif
#if P_GEN_7_POKEMON == TRUE
    ...
    [SPECIES_BASCULIN_WHITE_STRIPED] = {{EVO_MOVE_FEMALE, MOVE_WAVE_CRASH, SPECIES_BASCULEGION_FEMALE},
                                        {EVO_MOVE_MALE, MOVE_WAVE_CRASH, SPECIES_BASCULEGION_MALE}},
#endif
#if P_GEN_9_POKEMON == TRUE
    [SPECIES_WOOPER_PALDEAN]        = {{EVO_LEVEL, 20, SPECIES_CLODSIRE}},
    [SPECIES_GIMMIGHOUL_CHEST]      = {{EVO_LEVEL_ITEM_COUNT_999, ITEM_GIMMIGHOUL_COIN, SPECIES_GHOLDENGO}},
