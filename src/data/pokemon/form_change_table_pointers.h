const struct FormChange *const gFormChangeTablePointers[NUM_SPECIES] =
{
    ...
    [SPECIES_BUTTERFREE_MEGA] = sButterfreeFormChangeTable,
    ...
    [SPECIES_RAICHU_MEGA] = sRaichuFormChangeTable,
    ...
    [SPECIES_MACHAMP_MEGA] = sMachampFormChangeTable,
    ...
    [SPECIES_KINGLER_MEGA] = sKinglerFormChangeTable,
    ...
    [SPECIES_LAPRAS_MEGA] = sLaprasFormChangeTable,
    ...
    [SPECIES_KINGDRA_MEGA] = sKingdraFormChangeTable,
    ...
    [SPECIES_TROPIUS] = sTropiusFormChangeTable,
    [SPECIES_TROPIUS_MEGA] = sTropiusFormChangeTable,
    ...
    [SPECIES_DEOXYS_NORMAL] = sDeoxysNormalFormChangeTable,
    ...
    [SPECIES_GARBODOR_MEGA] = sGarbodorFormChangeTable,
    ...
    [SPECIES_MELMETAL_MEGA] = sMelmetalFormChangeTable,
#endif
#if P_GEN_8_POKEMON == TRUE
    [SPECIES_RILLABOOM] = sRillaboomFormChangeTable,
    [SPECIES_RILLABOOM_MEGA] = sRillaboomFormChangeTable,
    [SPECIES_CINDERACE] = sCinderaceFormChangeTable,
    [SPECIES_CINDERACE_MEGA] = sCinderaceFormChangeTable,
    [SPECIES_INTELEON] = sInteleonFormChangeTable,
    [SPECIES_INTELEON_MEGA] = sInteleonFormChangeTable,
    [SPECIES_CORVIKNIGHT] = sCorviknightFormChangeTable,
    [SPECIES_CORVIKNIGHT_MEGA] = sCorviknightFormChangeTable,
    [SPECIES_ORBEETLE] = sOrbeetleFormChangeTable,
    [SPECIES_ORBEETLE_MEGA] = sOrbeetleFormChangeTable,
    [SPECIES_DREDNAW] = sDrednawFormChangeTable,
    [SPECIES_DREDNAW_MEGA] = sDrednawFormChangeTable,
    [SPECIES_COALOSSAL] = sCoalossalFormChangeTable,
    [SPECIES_COALOSSAL_MEGA] = sCoalossalFormChangeTable,
    [SPECIES_SANDACONDA] = sSandacondaFormChangeTable,
    [SPECIES_SANDACONDA_MEGA] = sSandacondaFormChangeTable,
    ...
    [SPECIES_CENTISKORCH_MEGA] = sCentiskorchFormChangeTable,
    [SPECIES_HATTERENE] = sHattereneFormChangeTable,
    [SPECIES_HATTERENE_MEGA] = sHattereneFormChangeTable,
    [SPECIES_GRIMMSNARL] = sGrimmsnarlFormChangeTable,
    [SPECIES_GRIMMSNARL_MEGA] = sGrimmsnarlFormChangeTable,
    ...
    [SPECIES_COPPERAJAH_MEGA] = sCopperajahFormChangeTable,
    ...
    [SPECIES_ETERNATUS] = sEternatusFormChangeTable,
    [SPECIES_ETERNATUS_PRIMAL] = sEternatusFormChangeTable,
    [SPECIES_URSHIFU_SINGLE_STRIKE_STYLE] = sUrshifuSingleStrikeFormChangeTable,
    [SPECIES_URSHIFU_SINGLE_STRIKE_STYLE_MEGA] = sUrshifuSingleStrikeFormChangeTable,
    [SPECIES_URSHIFU_RAPID_STRIKE_STYLE] = sUrshifuRapidStrikeFormChangeTable,
    [SPECIES_URSHIFU_RAPID_STRIKE_STYLE_MEGA] = sUrshifuRapidStrikeFormChangeTable,
