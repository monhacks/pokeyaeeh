const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_OINKOLOGNE_MALE] = sOinkologneLevelUpLearnset,
    ...
    [SPECIES_TAUROS_PALDEAN_COMBAT_BREED] = sTaurosPaldeanComabtBreedLevelUpLearnset,
    // Misc Forms
    // Cosplay Pikachu
    ...
    [SPECIES_GARBODOR_MEGA] = sGarbodorLevelUpLearnset,
    [SPECIES_MELMETAL_MEGA] = sMelmetalLevelUpLearnset,
    [SPECIES_RILLABOOM_MEGA] = sRillaboomLevelUpLearnset,
    [SPECIES_CINDERACE_MEGA] = sCinderaceLevelUpLearnset,
    [SPECIES_INTELEON_MEGA] = sInteleonLevelUpLearnset,
    [SPECIES_CORVIKNIGHT_MEGA] = sCorviknightLevelUpLearnset,
    [SPECIES_ORBEETLE_MEGA] = sOrbeetleLevelUpLearnset,
    [SPECIES_DREDNAW_MEGA] = sDrednawLevelUpLearnset,
    [SPECIES_COALOSSAL_MEGA] = sCoalossalLevelUpLearnset,
    [SPECIES_SANDACONDA_MEGA] = sSandacondaLevelUpLearnset,
    [SPECIES_CENTISKORCH_MEGA] = sCentiskorchLevelUpLearnset,
    [SPECIES_HATTERENE_MEGA] = sHattereneLevelUpLearnset,
    [SPECIES_GRIMMSNARL_MEGA] = sGrimmsnarlLevelUpLearnset,
    [SPECIES_COPPERAJAH_MEGA] = sCopperajahLevelUpLearnset,
    [SPECIES_URSHIFU_SINGLE_STRIKE_STYLE_MEGA] = sUrshifuSingleStrikeStyleLevelUpLearnset,
