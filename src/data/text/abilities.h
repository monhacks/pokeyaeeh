...
static const u8 sStenchDescription[] = _("May cause a foe to flinch. (10%)");
static const u8 sDrizzleDescription[] = _("Summons rain in battle.");
static const u8 sSpeedBoostDescription[] = _("Raises Speed every turn.");
...
static const u8 sSandVeilDescription[] = _("Ups evasion in a sandstorm. (25%)");
static const u8 sStaticDescription[] = _("Paralyzes on contact. (30%)");
...
static const u8 sCompoundEyesDescription[] = _("Increases accuracy. (30%)");
...
static const u8 sFlashFireDescription[] = _("Powers up Fire moves if hit by fire.");
...
static const u8 sEffectSporeDescription[] = _("Leaves spores on contact. (30%)");
static const u8 sSynchronizeDescription[] = _("Passes on status problems.");
static const u8 sClearBodyDescription[] = _("Prevents stat reduction by foes.");
static const u8 sNaturalCureDescription[] = _("Cures major status upon switching out.");
...
static const u8 sIlluminateDescription[] = _("Increases encounters & accuracy. (20%)");
static const u8 sTraceDescription[] = _("Copies the foe's ability.");
static const u8 sHugePowerDescription[] = _("Doubles Attack.");
static const u8 sPoisonPointDescription[] = _("Poisons foe on contact. (30%)");
...
static const u8 sKeenEyeDescription[] = _("Prevents Acc loss & raises Acc. (20%)");
static const u8 sHyperCutterDescription[] = _("Prevents Atk fall. Raises crit chance.");
static const u8 sPickupDescription[] = _("May pick up items.");
static const u8 sTruantDescription[] = _("Moves only every two turns.");
static const u8 sHustleDescription[] = _("Trades accuracy for power. (-20%, 50%)");
static const u8 sCuteCharmDescription[] = _("Infatuates on contact. (30%)");
static const u8 sPlusDescription[] = _("Boosts special moves with Minus. (50%)");
static const u8 sMinusDescription[] = _("Boosts special moves with Plus. (50%)");
...
static const u8 sShedSkinDescription[] = _("Heals major status by shedding. (33%)");
static const u8 sGutsDescription[] = _("Ups Attack if suffering. (50%)");
static const u8 sMarvelScaleDescription[] = _("Ups Defense if suffering. (50%)");
static const u8 sLiquidOozeDescription[] = _("Draining moves damage the foe.");
static const u8 sOvergrowDescription[] = _("Ups Grass moves in a pinch. (50%)");
static const u8 sBlazeDescription[] = _("Ups Fire moves in a pinch. (50%)");
static const u8 sTorrentDescription[] = _("Ups Water moves in a pinch. (50%)");
static const u8 sSwarmDescription[] = _("Ups Bug moves in a pinch. (50%)");
...
static const u8 sWhiteSmokeDescription[] = _("Prevents stat reduction by foes.");
static const u8 sShellArmorDescription[] = _("Blocks critical hits.");
static const u8 sAirLockDescription[] = _("Negates weather effects on the field.");
static const u8 sTangledFeetDescription[] = _("Ups evasion if confused. (50%)");
static const u8 sMotorDriveDescription[] = _("Electric-type moves raises Speed.");
static const u8 sRivalryDescription[] = _("Powers up against same gender. (25%)");
static const u8 sSteadfastDescription[] = _("Flinching raises Speed.");
static const u8 sSnowCloakDescription[] = _("Ups evasion in snow. (25%)");
static const u8 sGluttonyDescription[] = _("Eats Berries early.");
static const u8 sAngerPointDescription[] = _("Critical hit maxes Attack stat.");
static const u8 sUnburdenDescription[] = _("Using a hold item doubles Speed.");
static const u8 sHeatproofDescription[] = _("Heat and burn protection.");
static const u8 sSimpleDescription[] = _("Doubles the stat changes.");
static const u8 sDrySkinDescription[] = _("Prefers moisture to heat.");
static const u8 sDownloadDescription[] = _("Raises either Attack or Sp. Atk.");
static const u8 sIronFistDescription[] = _("Boosts punching moves. (50%)");
...
static const u8 sMagicGuardDescription[] = _("Only damaged by direct attacks.");
static const u8 sNoGuardDescription[] = _("Ensures that all moves hit.");
static const u8 sStallDescription[] = _("Always moves last.");
static const u8 sTechnicianDescription[] = _("Boosts weaker moves. (50%)");
static const u8 sLeafGuardDescription[] = _("Blocks major status in sunshine.");
...
static const u8 sUnawareDescription[] = _("Ignores stat changes except speed.");
static const u8 sTintedLensDescription[] = _("Ups “not very effective” hits. (50%)");
static const u8 sFilterDescription[] = _("Weakens “super-effective” hits. (25%)");
static const u8 sSlowStartDescription[] = _("Ups Attack and Speed in 2 turns. (25%)");
static const u8 sScrappyDescription[] = _("Normal & Fighting moves hit Ghost-types.");
...
static const u8 sRecklessDescription[] = _("Boosts moves with recoil. (25%)");
static const u8 sMultitypeDescription[] = _("Changes type to its Plate.");
static const u8 sFlowerGiftDescription[] = _("Allies power up in sunshine. (50%)");
...
static const u8 sSheerForceDescription[] = _("Trades effects for power. (33%)");
static const u8 sContraryDescription[] = _("Inverts stat changes.");
static const u8 sUnnerveDescription[] = _("Foes can't eat Berries.");
static const u8 sDefiantDescription[] = _("Raises Attack if stats are lowered.");
static const u8 sDefeatistDescription[] = _("Lowers offences when below 50% HP. (25%)");
static const u8 sCursedBodyDescription[] = _("Disables moves on contact. (30%)");
static const u8 sHealerDescription[] = _("Cures ally's major status. (30%)");
static const u8 sFriendGuardDescription[] = _("Lowers damage received by allies. (25%)");
static const u8 sWeakArmorDescription[] = _("Raises Speed and lowers Defense when hit.");
static const u8 sHeavyMetalDescription[] = _("Doubles weight in battle.");
static const u8 sLightMetalDescription[] = _("Halves weight in battle.");
static const u8 sMultiscaleDescription[] = _("Halves damage received at full HP.");
static const u8 sToxicBoostDescription[] = _("Boosts Attack if poisoned. (50%)");
static const u8 sFlareBoostDescription[] = _("Boosts Sp. Atk if burned. (50%)");
static const u8 sHarvestDescription[] = _("May recycle a used Berry. (50%)");
static const u8 sTelepathyDescription[] = _("Can't be damaged by an ally.");
static const u8 sMoodyDescription[] = _("Randomly raises a stat and drops another.");
static const u8 sOvercoatDescription[] = _("Blocks weather damage and powders.");
static const u8 sRegeneratorDescription[] = _("Heals 33% health after switching out.");
...
static const u8 sAnalyticDescription[] = _("Moving last boosts power. (30%)");
...
static const u8 sMummyDescription[] = _("Changes target's ability on contact.");
static const u8 sMoxieDescription[] = _("KOs raise Attack by one stage.");
static const u8 sJustifiedDescription[] = _("Dark hits raise Attack.");
static const u8 sRattledDescription[] = _("Bug, Dark & Ghost hits raise Speed.");
static const u8 sMagicBounceDescription[] = _("Reflects status moves back to the foe.");
static const u8 sSapSipperDescription[] = _("Grass moves increases Attack.");
static const u8 sPranksterDescription[] = _("Status moves go first. Immune against Dark.");
static const u8 sSandForceDescription[] = _("Boosts moves in sandstorm. (30%)");
static const u8 sZenModeDescription[] = _("Transforms at half HP.");
static const u8 sVictoryStarDescription[] = _("Raises allies accuracy.");
...
static const u8 sFurCoatDescription[] = _("Halves physical damage.");
static const u8 sBulletproofDescription[] = _("Avoids ballistic moves.");
static const u8 sCompetitiveDescription[] = _("Raises Sp. Atk if stats are lowered.");
static const u8 sStrongJawDescription[] = _("Boosts biting moves. (50%)");
static const u8 sRefrigerateDescription[] = _("Normal moves become Ice. (20%)");
static const u8 sSweetVeilDescription[] = _("Prevents allies from falling sleep.");
static const u8 sStanceChangeDescription[] = _("Changes form after using King's Shield.");
static const u8 sGaleWingsDescription[] = _("Flying moves go first.");
static const u8 sMegaLauncherDescription[] = _("Boosts beam, cannon & pulse moves.(50%)");
static const u8 sGrassPeltDescription[] = _("Heals every turn, no indirect damage.");
static const u8 sSymbiosisDescription[] = _("Passes its item to an ally.");
static const u8 sToughClawsDescription[] = _("Boosts contact moves. (30%)");
static const u8 sPixilateDescription[] = _("Normal moves become Fairy. (20%)");
static const u8 sGooeyDescription[] = _("Lowers Speed by one stage on contact.");
static const u8 sAerilateDescription[] = _("Normal moves become Flying. (20%)");
static const u8 sParentalBondDescription[] = _("Moves hit twice. (50%)");
static const u8 sDarkAuraDescription[] = _("Boosts Dark moves. (33%)");
static const u8 sFairyAuraDescription[] = _("Boosts Fairy moves. (33%)");
...
static const u8 sLiquidVoiceDescription[] = _("Makes sound moves Water. (20%)");
static const u8 sTriageDescription[] = _("Healing moves go first.");
static const u8 sGalvanizeDescription[] = _("Normal moves turn Electric. (20%)");
static const u8 sSurgeSurferDescription[] = _("Doubles Speed in Electric Terrain.");
...
static const u8 sCorrosionDescription[] = _("Poison-type moves hit Steel-types.");
static const u8 sComatoseDescription[] = _("Always drowsing. Immune to major status.");
static const u8 sQueenlyMajestyDescription[] = _("Protects from priority moves.");
...
static const u8 sBatteryDescription[] = _("Powers up ally side moves. (30%)");
static const u8 sFluffyDescription[] = _("Halves contact damage, but doubles Fire.");
static const u8 sSoulHeartDescription[] = _("KOs raise Sp. Atk by one stage.");
...
static const u8 sElectricSurgeDescription[] = _("Sets Electric Terrain on switch in.");
static const u8 sPsychicSurgeDescription[] = _("Sets Psychic Terrain on switch in.");
static const u8 sMistySurgeDescription[] = _("Sets Misty Terrain on switch in.");
static const u8 sGrassySurgeDescription[] = _("Sets Grassy Terrain on switch in.");
static const u8 sFullMetalBodyDescription[] = _("Prevents stat reduction by foes.");
static const u8 sNeuroforceDescription[] = _("Ups “super-effective” hits. (25%)");
static const u8 sIntrepidSwordDescription[] = _("Raises Attack on entry.");
static const u8 sDauntlessShieldDescription[] = _("Raises Defense on entry.");
...
static const u8 sMirrorArmorDescription[] = _("Reflect stat decreases back to the foe.");
...
static const u8 sPunkRockDescription[] = _("Ups and resists sound. (30%, -50%)");
...
static const u8 sIceFaceDescription[] = _("Snow renew free hit.");
static const u8 sPowerSpotDescription[] = _("Powers up ally moves. (30%)");
...
static const u8 sRockyPayloadDescription[] = _("Powers up Rock-type moves. (50%)");
...
static const u8 sSharpnessDescription[] = _("Boosts cutting moves. (50%)");
...
static const u8 sMindsEyeDescription[] = _("Ignores evasiveness and hits Ghosts.");
...
static const u8 sGroundShockDescription[] = _("Electric-type moves hits Ground-types.");
...
static const u8 sMetalSurgeDescription[] = _("Sets Metal Terrain on switch.");
...
static const u8 sBoxerBarrageDescription[] = _("Punching moves hit twice. (50%)");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_TRANSISTOR] = _("Transistor"),
    [ABILITY_DRAGONS_MAW] = _("Dragon's Maw"),
    [ABILITY_CHILLING_NEIGH] = _("Chill Neigh"),
    [ABILITY_GRIM_NEIGH] = _("Grim Neigh"),
    [ABILITY_AS_ONE_ICE_RIDER] = _("As One"),
    [ABILITY_AS_ONE_SHADOW_RIDER] = _("As One"),
    ...
    [ABILITY_POISON_PUPPETEER] = _("PoisonPupptr"),
    [ABILITY_BRUTAL_LEGS] = _("Brutal Legs"),
    [ABILITY_HARD_SPINNER] = _("Hard Spinner"),
    [ABILITY_TAILSTREAM] = _("Tailstream"),
    [ABILITY_PHANTOM_GALE] = _("Phantom Gale"),
    ...
    [ABILITY_SOLAR_RUSH] = _("Solar Rush"),
    [ABILITY_DEAD_SHOT] = _("Dead Shot"),
    [ABILITY_DRAGONS_FURY] = _("Dragon'sFury"),
};
#endif
