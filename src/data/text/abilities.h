...
static const u8 sStanceChangeDescription[] = _("Changes stance as it battles.");
...
static const u8 sChillingNeighDescription[] = _("KOs raise Attack stat.");
static const u8 sGrimNeighDescription[] = _("KOs raise Sp. Atk stat.");
