...
static const u8 sSimpleDescription[] = _("PDoubles the stat changes.");
...
static const u8 sSlowStartDescription[] = _("Attack and Speed are halved for 5 turns.");
...
static const u8 sBatteryDescription[] = _("Boosts ally's Sp. Atk. (30%)");
