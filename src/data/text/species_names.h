const u8 gSpeciesNames[NUM_SPECIES][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_SQUAWKABILLY_GREEN_PLUMAGE] = _("Sqawkabily"),
    ...
    [SPECIES_BRAMBLEGHAST] = _("Bramblghst"),
    ...
    [SPECIES_DUDUNSPARCE_TWO_SEGMENT] = _("Dudunsprce"),
    ...
    [SPECIES_POLTCHAGEIST_COUNTERFEIT] = _("Poltchagei"),
    [SPECIES_POLTCHAGEIST_ARTISAN] = _("Poltchagei"),
    ...
    [SPECIES_TERAPAGOS_NORMAL] = _("Terapagos"),
...
//Hisuian Forms
    ...
    [SPECIES_GARBODOR_MEGA] = _("Garbodor"),
    [SPECIES_MELMETAL_MEGA] = _("Melmetal"),
    [SPECIES_RILLABOOM_MEGA] = _("Rillaboom"),
    [SPECIES_CINDERACE_MEGA] = _("Cinderace"),
    [SPECIES_INTELEON_MEGA] = _("Inteleon"),
    [SPECIES_CORVIKNIGHT_MEGA] = _("Corviknigh"),
    [SPECIES_ORBEETLE_MEGA] = _("Orbeetle"),
    [SPECIES_DREDNAW_MEGA] = _("Drednaw"),
    [SPECIES_COALOSSAL_MEGA] = _("Coalossal"),
    [SPECIES_SANDACONDA_MEGA] = _("Sandaconda"),
    [SPECIES_CENTISKORCH_MEGA] = _("Centiskorc"),
    [SPECIES_HATTERENE_MEGA] = _("Hatterene"),
    [SPECIES_GRIMMSNARL_MEGA] = _("Grimmsnarl"),
    [SPECIES_COPPERAJAH_MEGA] = _("Copperajah"),
    [SPECIES_URSHIFU_SINGLE_STRIKE_STYLE_MEGA] = _("Urshifu"),
    [SPECIES_URSHIFU_RAPID_STRIKE_STYLE_MEGA] = _("Urshifu"),
#endif
#if P_GEN_9_POKEMON == TRUE
    // Oinkologne
