...
static const u8 sGlacialSlamDescription[] = _(
...
static const u8 sFrostBladeDescription[] = _(
    "Slashes the foe with ice.\n"
    "May frosbtie. High Crit ratio.");
...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] =
{
    ...
    [MOVE_BEHEMOTH_BLADE - 1] = sChipAwayDescription,
    [MOVE_BEHEMOTH_BASH - 1] = sBodyPressDescription,
...
static const u8 sMoveFourLineDescription_Cut[] = _("The user slashes\nthe foe with sharp,\ncrossed limbs. High\ncritical-hit ratio.");
...
static const u8 sMoveFourLineDescription_MistyTerrain[] = _("For 5 turns, status\nmoves will fail and\nFairy-type moves\ndeal more damage.");
...
static const u8 sMoveFourLineDescription_DireClaw[]      = _("The user lashes out\nand may leave the\nfoe poisoned,\nparalyzed, or asleep.");
static const u8 sMoveFourLineDescription_PsyshieldBash[] = _("Cloaking itself in\npsychic energy, the\nuser slams the foe.\nMay raise Defense.");
static const u8 sMoveFourLineDescription_PowerShift[] = _("The user swaps its\nAttack and Defense\nstats.");
static const u8 sMoveFourLineDescription_StoneAxe[] = _("The user swings its\nstone axe to attack.\nLeaves Splinters\nthat hurt the foe.");
static const u8 sMoveFourLineDescription_SpringtideStorm[] = _("The user wraps the\nfoe in winds of love\nand hate. This lowers\nthe foe's Attack.");
static const u8 sMoveFourLineDescription_MysticalPower[] = _("The user emits\nmysterious power to\nattack the foe. This\nraises Sp. Atk.");
static const u8 sMoveFourLineDescription_RagingFury[] = _("The user rampages\naround spewing fire\nfor 2 or 3 turns and\nbecomes confused.");
static const u8 sMoveFourLineDescription_WaveCrash[] = _("The user shrouds\nitself in water and\nslams the foe. This\ndamages the user.");
static const u8 sMoveFourLineDescription_Chloroblast[] = _("The user attack the\nfoe with its amassed\nchlorophyll. This\nhurts the user a lot.");
static const u8 sMoveFourLineDescription_MountainGale[] = _("The user hurls large\nchucks of ice at the\nfoe. This may cause\nthe foe to flinch.");
static const u8 sMoveFourLineDescription_VictoryDance[] = _("An intense dance\nwhich boosts the\nuser's Attack,\nDefense and Speed.");
static const u8 sMoveFourLineDescription_HeadlongRush[] = _("The user smashes\ninto the foe. This\ncuts the user's Def\nand Sp. Def stats.");
...
static const u8 sMoveFourLineDescription_BleakwindStorm[] = _("Attacks with savage,\ncold winds that may\ncause frostbite to\nthe foe.");
static const u8 sMoveFourLineDescription_WildboltStorm[] = _("Attacks with thund-\nerous winds that may\ncause paralysis to\nthe foe.");
...
// GEN 9
static const u8 sMoveFourLineDescription_TeraBlast[] = _("Move\nunder\ndevelopment!");
static const u8 sMoveFourLineDescription_SilkTrap[] = _("The user protects\nitself with a silken\ntrap. Contact by the\nfoe lowers its Speed.");
static const u8 sMoveFourLineDescription_AxeKick[] = _("The user slams its\nheel on the foe. May\ncause confusion. If\nmissed takes recoil.");
static const u8 sMoveFourLineDescription_LastRespects[] = _("The user attacks to\navenge its allies.\nMore fainted allies,\ngreater the power.");
static const u8 sMoveFourLineDescription_LuminaCrash[] = _("The user unleashes a\npeculiar light which\nharshly lowers the\nfoe's Sp. Def.");
static const u8 sMoveFourLineDescription_OrderUp[] = _("The user attacks\nwith poise. Gets a\nstat boost based on\nthe Tatsugiri's form.");
static const u8 sMoveFourLineDescription_JetPunch[] = _("Summons a torrent\naround the fist and\npunches the foe.\nAlways goes first.");
static const u8 sMoveFourLineDescription_SpicyExtract[] = _("The user's spices\nsharply raises the\nfoe's Atk & harshly\nlowers its Def.");
static const u8 sMoveFourLineDescription_SpinOut[] = _("The user furiously\nspins to attack the\nfoe. Harshly lowers\nthe user's Speed.");
static const u8 sMoveFourLineDescription_PopulationBomb[] = _("The user's fellows\ngather in droves to\nattack the foe 1 to\n10 times in a row.");
static const u8 sMoveFourLineDescription_IceSpinner[] = _("The user covers its\nfeet in thin ice and\nslams at the foe.\nRemoves Terrain.");
...
static const u8 sMoveFourLineDescription_KowtowCleave[] = _("The user slashes the\nfoe after kowtowing\nto lower its guard.\nNever misses.");
static const u8 sMoveFourLineDescription_FlowerTrick[] = _("The user throws a\nbounquet at the foe.\nThis move always hits\nand lands a crit hit.");
static const u8 sMoveFourLineDescription_TorchSong[] = _("The user blows fire\nas if singing a song.\nThis boosts the\nuser's Sp. Atk.");
static const u8 sMoveFourLineDescription_AquaStep[] = _("The user attacks the\nfoe with light and\nfluid dance steps.\nRaises user's Speed.");
static const u8 sMoveFourLineDescription_RagingBull[] = _("This move's type\ndepends on the user\nform. Also breaks\nthe foe's barriers.");
static const u8 sMoveFourLineDescription_MakeItRain[] = _("The user attacks by\nthrowing coins. This\nlowers its Sp. Atk.\nMoney is earned.");
static const u8 sMoveFourLineDescription_Ruination[] = _("The user summons a\nruinous disaster.\nThis cuts the foe's\nHP in half.");
static const u8 sMoveFourLineDescription_CollisionCourse[] = _("The user causes an\nancient explosion.\nDeals more damage if\nsuper-effective.");
static const u8 sMoveFourLineDescription_ElectroDrift[] = _("The user attacks\nwith future power.\nDeals more damage if\nsuper-effective.");
static const u8 sMoveFourLineDescription_ShedTail[] = _("The user creates a\nsubstitute using its own\nHP and switches with\na party Pokémon.");
static const u8 sMoveFourLineDescription_ChillyReception[] = _("The user tells a bad\njoke and switches\nwith an ally. This\nsummons a snowstorm.");
static const u8 sMoveFourLineDescription_TidyUp[] = _("The user tidies up\nand removes hazards.\nThis also boosts\nits Atk and Speed.");
static const u8 sMoveFourLineDescription_Snowscape[] = _("The user summons a\nsnowtorm lasting 5\nturns. Raises the\nDef. of Ice-types.");
static const u8 sMoveFourLineDescription_Pounce[] = _("The user attacks by\npouncing on the foe.\nThis lowers the\nfoe's Speed.");
static const u8 sMoveFourLineDescription_Trailblaze[] = _("The user attacks\nsuddenly as leaping\nfrom tall grass.\nRaises user's Speed.");
static const u8 sMoveFourLineDescription_ChillingWater[] = _("The user attacks\nthe foe by showering\nit with cold water.\nLowers its Atk.");
static const u8 sMoveFourLineDescription_HyperDrillDescription[] = _("The user spins the\npointed part of its\nbody to attack. Can\nhit through protect.");
static const u8 sMoveFourLineDescription_TwinBeam[] = _("The user shoots two\nmystical beams from\nits eyes. The foe is\nhit twice in a row.");
static const u8 sMoveFourLineDescription_RageFist[] = _("The user converts\nits rage into energy\nto attack. More hits,\ngreater the power.");
static const u8 sMoveFourLineDescription_ArmorCannon[] = _("The user shoots its\nown armor as project-\niles. This lowers its\nDef. and Sp. Def.");
static const u8 sMoveFourLineDescription_BitterBlade[] = _("The user forces its\nbitter feelings into\na slashing attack\nand restores health.");
static const u8 sMoveFourLineDescription_DoubleShock[] = _("The user attacks\nwith all charge. The\nuser is no longer\nan Electric-type.");
static const u8 sMoveFourLineDescription_GigatonHammer[] = _("The user swings to\nattack with a hammer.\nThis move can't be\nused twice in a row.");
static const u8 sMoveFourLineDescription_Comeuppance[] = _("The user hits with\nmuch greater force\nagainst the foe\nthat last hurt it.");
static const u8 sMoveFourLineDescription_AquaCutter[] = _("The user expels\npressurized water to\ncut the foe. It has a\nhigh crit hit ratio.");
static const u8 sMoveFourLineDescription_BlazingTorque[] = _("----");
static const u8 sMoveFourLineDescription_WickedTorque[] = _("----");
static const u8 sMoveFourLineDescription_NoxiousTorque[] = _("----");
static const u8 sMoveFourLineDescription_CombatTorque[] = _("----");
static const u8 sMoveFourLineDescription_MagicalTorque[] = _("----");
static const u8 sMoveFourLineDescription_Psyblade[] = _("The user rends the\ntarget with ethereal\nblade. Boosted in\nElectric Terrain.");
static const u8 sMoveFourLineDescription_HydroSteam[] = _("The user blasts the\ntarget with boiling\nhot water. Boosted\nin harsh sunlight.");
static const u8 sMoveFourLineDescription_BloodMoon[] = _("The user channels\nthe moon's spirit at\nfull power. Can't be\nused twice in a row.");
...
static const u8 sMoveFourLineDescription_SupercellSlam[] = _("the user electrifies\nits body and drops\nonto the foe. Causes\nrecoil if missed.");
...
const u8 *const gMoveFourLineDescriptionPointers[MOVES_COUNT - 1] = {
    ...
    [MOVE_HYPER_DRILL       - 1] = sMoveFourLineDescription_HyperDrillDescription,
