...
const u32 gTrainerFrontPic_AsianDad[] = INCBIN_U32("graphics/trainers/front_pics/asian_dad.4bpp.lz");
const u32 gTrainerPalette_AsianDad[] = INCBIN_U32("graphics/trainers/front_pics/asian_dad.gbapal.lz");
