...
static void BagMenu_ItemPrintCallback(u8 windowId, u32 itemIndex, u8 y)
{
    ...
    if (itemIndex != LIST_CANCEL)
    {
        ...
        else if (gBagPosition.pocket != KEYITEMS_POCKET && gBagPosition.pocket != TMHM_POCKET && ItemId_GetImportance(itemId) == FALSE)
        {
            // Print item quantity
...
static void PrintItemSoldAmount(int windowId, int numSold, int moneyEarned)
{
    ...
    PrintMoneyAmount(windowId, 26, 1, moneyEarned, 0);
}
...
static const u16 sItemsByType[ITEMS_COUNT] =
{
    ...
    [ITEM_RETRO_MAIL] = ITEM_TYPE_MAIL,
        ...
        [ITEM_INTELEONITE] = ITEM_TYPE_MEGA_STONE,
        [ITEM_CORVIKNIGHTITE] = ITEM_TYPE_MEGA_STONE,
        [ITEM_ORBEETLITE] = ITEM_TYPE_MEGA_STONE,
        [ITEM_DREDNITE] = ITEM_TYPE_MEGA_STONE,
        [ITEM_COALOSSALITE] = ITEM_TYPE_MEGA_STONE,
        [ITEM_SANDACONDANITE] = ITEM_TYPE_MEGA_STONE,
        [ITEM_CENTISKORCHITE] = ITEM_TYPE_MEGA_STONE,
        [ITEM_HATTERENITE] = ITEM_TYPE_MEGA_STONE,
        [ITEM_GRIMMSNARLITE] = ITEM_TYPE_MEGA_STONE,
        [ITEM_COPPERAJAHITE] = ITEM_TYPE_MEGA_STONE,
        [ITEM_NIDOQUEENITE] = ITEM_TYPE_MEGA_STONE,
        [ITEM_NIDOKINGITE] = ITEM_TYPE_MEGA_STONE,
        [ITEM_MILOTICITE] = ITEM_TYPE_MEGA_STONE,
        [ITEM_RAICHUNITE] = ITEM_TYPE_MEGA_STONE,
        [ITEM_TROPIUSITE] = ITEM_TYPE_MEGA_STONE,
        [ITEM_KINGDRITE] = ITEM_TYPE_MEGA_STONE,
        ...
        [ITEM_STEEL_ARMOR] = ITEM_TYPE_EVOLUTION_ITEM,
