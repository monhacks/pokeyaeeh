...
static void PrintDisplayMonInfo(void)
{
    ...
    if (sStorage->boxOption != OPTION_MOVE_ITEMS)
    {
        ...
        AddTextPrinterParameterized(WIN_DISPLAY_INFO, FONT_NARROWER, sStorage->displayMonItemName, 6, 43, TEXT_SKIP_DRAW, NULL);
    }
    else
    {
        AddTextPrinterParameterized(WIN_DISPLAY_INFO, FONT_NARROWER, sStorage->displayMonItemName, 6, 0, TEXT_SKIP_DRAW, NULL);
