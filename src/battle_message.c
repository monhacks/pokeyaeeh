...
static const u8 sText_ScriptingFainted[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}\nfainted!\p");
...
static const u8 sText_EscapingIsImpossible[] = _("{B_OPPONENT_MON1_NAME} is too strong!\nEscaping is impossible\p");
...
static const u8 sText_PkmnAlreadyAtFullHealth[] = _("{B_DEF_NAME_WITH_PREFIX}'s side\nis already at full health!");
...
static const u8 sText_LegendaryFendedBallOff[] = _("{B_DEF_NAME} fended the ball off!");
static const u8 sText_YouMustWeakenIt[] = _("You must weaken it before\nattempting to catch it!");
static const u8 sText_VictoryCatch[] = _("{B_OPPONENT_MON1_NAME} submits.\nWill {B_PLAYER_NAME} capture it?");
...
static const u8 sText_MegaEvoWild[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_LAST_ITEM} is\noverflowing with Mega energy!");
static const u8 sText_MegaWishEvoWild[] = _("{B_ATK_NAME_WITH_PREFIX} is\noverflowing with Mega energy!");
...
static const u8 sText_BeingHitChargedPkmnWithPower[] = _("{B_DEF_NAME_WITH_PREFIX} is\ncharged with power!");
...
static const u8 sText_MoonlightGotBright[] = _("The moonlight got bright!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_FOGBLOWNAWAY - BATTLESTRINGS_TABLE_START] = sText_FogBlownAway,
    ...
    [STRINGID_SCRIPTINGFAINTED - BATTLESTRINGS_TABLE_START] = sText_ScriptingFainted,
    ...
    [STRINGID_PKMNATFULLHEALTH - BATTLESTRINGS_TABLE_START] = sText_PkmnAlreadyAtFullHealth,
    ...
    [STRINGID_CANTESCAPE2 - BATTLESTRINGS_TABLE_START] = sText_EscapingIsImpossible,
    ...
    [STRINGID_WILDMEGAEVO - BATTLESTRINGS_TABLE_START] = sText_MegaEvoWild,
    [STRINDID_WILDWISHMEGAEVO - BATTLESTRINGS_TABLE_START] = sText_MegaWishEvoWild,
...
const u16 gTerrainPreventsStringIds[] =
{
    ...
    [B_MSG_TERRAINPREVENTS_METAL] = STRINGID_METALTERRAINPREVENTSDEF
};
...
const u16 gMoveWeatherChangeStringIds[] =
{
    ...
    [B_MSG_STARTED_FOG]       = STRINGID_FOGISDEEP, // Unused, can use for custom moves that set fog
    [B_MSG_STARTED_MOON]      = STRINGID_MOONLIGHTGOTBRIGHT,
};
...
const u16 gWeatherStartsStringIds[] =
{
    ...
    [WEATHER_NIGHTTIME]          = STRINGID_MOONLIGHTGOTBRIGHT
};
...
static const u8 sText_Semifinal[] = _("Semi Final");
