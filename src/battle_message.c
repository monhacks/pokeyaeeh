...
static const u8 sText_MetalTerrain[] = _("Placeholder for now.\nlol.");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_METALTERRAINPREVENTS - BATTLESTRINGS_TABLE_START] = sText_MetalTerrain,
...
const u16 gTerrainPreventsStringIds[] =
{
    ...
    [B_MSG_TERRAINPREVENTS_METAL] = STRINGID_METALTERRAINPREVENTS
};
