...
static const u8 LandmarkName_EmberRidge[] = _("Ember Ridge");
...
static const struct Landmark Landmark_EmberRidge = {LandmarkName_EmberRidge, FLAG_LANDMARK_EMBER_RIDGE};
