...
const u8 gText_MainMenuNewGameVersion[] = _("New Game{CLEAR_TO 150}{COLOR GREEN}Demo v0.3.0");
const u8 gText_MainMenuContinue[] = _("Continue{CLEAR_TO 150}{COLOR GREEN}Demo v0.3.0");
...
const u8 *const gBagMenu_ReturnToStrings[] =
{
    ...
    [ITEMMENULOCATION_TREASURES]           = gText_TheField
};
...
const u8 gText_RelearnMoves[] = _("Relearn Moves");
const u8 gText_EggMoves[] = _("Egg Moves");
...
const u8 gText_Steven[] = _("Mystic");
const u8 gText_Brawly[] = _("Oisin");
const u8 gText_Winona[] = _("Krypto");
...
const u8 gText_1F_Entry[] = _("1F: Entry");
const u8 gText_2F_TrainerItems[] = _("2F: Trainer Items");
const u8 gText_3F_TypeBoosters[] = _("3F: Type Boosters");
const u8 gText_4F_TMsTutor[] = _("4F: TMs & Tutors");
const u8 gText_5F_Decorations[] = _("5F: Decorations");
...
const u8 gText_TextSpeed[] = _("Instant text");
...
const u8 gText_QuickBattleRunBA[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}B{RIGHT_ARROW}A");
...
const u8 gText_SavingVersionNum[] =_("Version");
const u8 gText_VersionNum[] = _("Demo v0.3.0");
...
const u8 gText_StevenMatchCallDesc[] = _("Cock and balls");
const u8 gText_StevenMatchCallName[] = _("Mystic");
...
const u8 gText_NormanMatchCallName[] = _("Chrizz");
...
const u8 gText_BrawlyMatchCallDesc[] = _("Green stoner");
const u8 gText_WattsonMatchCallDesc[] = _("Old but burnin");
const u8 gText_FlanneryMatchCallDesc[] = _("Normally abnormal");
const u8 gText_WinonaMatchCallDesc[] = _("Chill metal dude");
const u8 gText_TateLizaMatchCallDesc[] = _("Toxic n' troll");
const u8 gText_JuanMatchCallDesc[] = _("Emo simp");
const u8 gText_EliteFourMatchCallDesc[] = _("Elite Four");
const u8 gText_ChampionMatchCallDesc[] = _("G.O.A.T.");
...
const u8 gText_Overheat[] = _("Overheat");
