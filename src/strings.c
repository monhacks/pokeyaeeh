...
const u8 gText_MainMenuNewGameVersion[] = _("New Game{CLEAR_TO 150}{COLOR GREEN}Demo v0.2.3");
const u8 gText_MainMenuContinue[] = _("Continue{CLEAR_TO 150}{COLOR GREEN}Demo v0.2.3");
...
const u8 gText_3F_Drugstore[] = _("3F: Type Boosters");
...
const u8 gText_VersionNum[] = _("Demo v0.2.3");
