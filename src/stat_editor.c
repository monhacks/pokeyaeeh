...
static const u8 sText_MenuABButtonTextMain[]   = _("Back");
...
static void PrintTitleToWindowEditState()
{
    ...
    BlitBitmapToWindow(WINDOW_1, sA_ButtonGfx, 165, (BUTTON_Y), 8, 8);
    BlitBitmapToWindow(WINDOW_1, sB_ButtonGfx, 175, (BUTTON_Y), 8, 8);
    AddTextPrinterParameterized4(WINDOW_1, FONT_NARROW, 187, 0, 0, 0, sMenuWindowFontColors[FONT_WHITE], TEXT_SKIP_DRAW, sText_MenuABButtonTextMain);
...
#define EDIT_INPUT_HALF_INCREASE_STATE      1
#define EDIT_INPUT_MAX_INCREASE_STATE       2
#define EDIT_INPUT_DECREASE_STATE           3
#define EDIT_INPUT_HALF_DECREASE_STATE      4
